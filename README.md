...
- The first work that connects speech module and LLM (ChatGLM) with an all-neural inferface in an all-neural way: https://github.com/phellonchen/X-LLM & https://github.com/MingLunHan/X-LLM-Speech
